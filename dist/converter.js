...
<body>
    ...
    async generatePNG(html, outputPath, width, height) {
    ...
    async generateSVG(html, outputPath, width, height) {
...
<svg width="${width}" height="${height || 600}" xmlns="http://www.w3.org/2000/svg">
  <foreignObject width="100%" height="100%">
    ...
    async copyToClipboard(imagePath) {
    ...
    async generatePreview(markdown, theme) {
